...
import com.ensas.reparationservice.exception.FuncErrorException;
import com.ensas.reparationservice.util.FileUploadUtil;
...
public class CloudinaryService {
    ...
    public CloudinaryResponse uploadFile(final MultipartFile file, final String fileName) {
        try {
            ...
            String publicId = "atlas/reparations/" + generatedName;
    ...
    private String extractPublicIdFromUrl(String url) {
        ...
        String folder = "atlas/reparations/";
        ...
        return url.substring(start, end); // ex : atlas/reparations/mon-image
    }
